...
"""
    ...
    <footer class="site-footer">
        ...
        <p style="margin-top: 12px; font-size: 13px;">Also from GougeStop: <a href="https://medcareprecheck.com" target="_blank" rel="noopener" style="color: #FF6B6B; font-weight: 600; text-decoration: none;">MedcarePrecheck</a> &#8212; Know if Medicare will cover your lab tests before you go.</p>
    </footer>
